...
public class ReportePPDAO {
   ...
   public static HashMap<String, Object> registrarReporte(ReportePP reporte) {
        ...
        if (conexionBD != null) {
            try {
                String sentencia = "INSERT INTO reportes_pp (id_proyecto_pp, fecha_subida, archivo_reporte, comentarios, matricula, tipo) " +
                                 "VALUES (?, NOW(), ?, ?, ?, ?)";
                PreparedStatement prepararSentencia = conexionBD.prepareStatement(sentencia);
                prepararSentencia.setInt(1, reporte.getIdProyectoPP());
